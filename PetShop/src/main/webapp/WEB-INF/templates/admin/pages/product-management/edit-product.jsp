                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <c:forEach items='${productImages}' var='productImage'>
                        <ul class="list-group">
                          <form class="list-group-item" method="post"
                            action="/admin/productImage-management/delete"
                      ...
                      <form method="post" class="form" action="/admin/productImage-management/create">
                    ...
                    <div class="col">
                      <div class="row">
                        <div class="col">
                          ...
                          <form method="post" class="form" action="/admin/product-management/update">
                            <input type="hidden" name="productId" value="${product.getId()}"></br>
                            <div class="input-group mb-3">
                        ...
                        <div class="col">
                          <div class="card pl-3 pr-3 pb-3">
                            ...
                            <c:forEach items='${listCategoryByProductIds}' var='category'>
                              <form method="post" action="/admin/categoryProduct-management/delete" onsubmit="return onDeleteImageHandler()">
                                <div class="input-group mb-3">
                                  <input type="hidden" name="productId" value="${product.getId()}">
                      ...
                      <div class="row mt-3" style="margin-bottom: 15px">
                        <div class="col">
                          <div class="card pl-3 pr-3 pb-3">
                            ...
                            <form method="post" action="/admin/categoryProduct-management/create">
                              <div class="input-group mb-3">
                                <input type="hidden" name="productId" value="${product.getId()}">
                                <span class="input-group-text">Loại</span>
                          ...
                          <ul class="list-group">
                            <c:forEach items="${productDescriptions}" var='des'>
                              <li class="list-group-item">
                                ...
                                <form method="post" action="/admin/productDescription-management/delete"
                                  onsubmit="return onDeleteImageHandler()">
                                  <input type="hidden" name="productId" value="${product.getId()}">
                      ...
                      <div class="row mt-3">
                        <div class="col">
                          <div class="card pl-3 pr-3 pb-3">
                            ...
                            <form method="post" action="/admin/productDescription-management/create">
                              <div class="input-group mb-3">
                                <input type="hidden" name="productId" value="${product.getId()}">
                                <span class="input-group-text">Loại</span>
                      ...
                      <div class="row mt-3">
                        <div class="col">
                            <form method="post" action="/admin/product-management/delete" onsubmit="return onDeleteImageHandler()">
                                <div class="input-group mb-3">
                                  <input type="hidden" name="productId" value="${product.getId()}">
