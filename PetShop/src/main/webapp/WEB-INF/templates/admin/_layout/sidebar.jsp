...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
			...
			<li class="nav-item active">
                <a class="nav-link" href="/admin/animal-management">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
                    <span>Loại thú cưng</span></a>
            </li>
            <!-- Nav Item - Pages Collapse Menu -->
            <li class="nav-item" style="display: none;">
                <a class="nav-link collapsed" href="/admin" data-toggle="collapse" data-target="#animalsCollapse"
                ...
                <div id="animalsCollapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="/admin/animal-management">Quản lý</a>
                    </div>
                </div>
            </li>
