...
@WebServlet("/admin/order-management/update")
public class AdminUpdateOrderServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.setAttribute("success_messages", new String[] { "Cập nhật giỏ hàng thành công" });
		response.sendRedirect("/admin/order-management?page=1&limit=50");
	}
}